...
REM Generate ffprobe info (text)
...
endlocal
goto :eof
```// filepath: /Users/cove/vhs/vhs/generate_info.bat
@echo off
setlocal enabledelayedexpansion
set "B3=%~dp0b3sum_windows_x64_bin.exe"
...
REM derive directory base name for combined blake3 file
for %%D in ("%CD%") do set "DIRNAME=%%~nD"
set "OUTBLAKE=%DIRNAME%.blake3"
