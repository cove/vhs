...
QTGMC(Preset="Very Slow",SourceMatch=3,Lossless=2,TR2=3,Sharpness=0.7,SLMode=2,SLRad=3,EZDenoise=0.4,GrainRestore=0.4,Border=true,EdiThreads=2,EdiMode="EEDI3")
SeparateFields()
