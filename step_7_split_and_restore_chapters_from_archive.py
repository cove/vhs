...
QTGMC(Preset="Very Slow",SourceMatch=3,Lossless=2,TR2=3,Sharpness=0.7,SLMode=2,SLRad=3,EZDenoise=0.4,EZKeepGrain=1.2,GrainRestore=0.4,CBorder=4,SBorder=4,EdiThreads=2)
SeparateFields()
